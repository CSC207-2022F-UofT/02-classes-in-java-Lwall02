...
public class Silly implements Comparable<Silly>{
     ...
     *
     * Creates a new Silly object.
     * This constructor takes in in two parameters as an argument.
     * this.name is set to the concatenation of both strings
     *
     * @param one part one of the name for this Silly instance.
     * @param two part two of the name for this Silly instance
     */
